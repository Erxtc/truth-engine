...
Example 16: proposedSolution('[true,false,null,0]') → [True,False,None,0]
Example 17: proposedSolution('{"a b":1}') → {"a b":1}
Example 18: proposedSolution('[[]]') → [[]]
Example 19: proposedSolution('{"":""}') → {"":""}
Example 20: proposedSolution('[-1,0,1]') → [-1,0,1]`,
    language: "python",
    complexity: "hard",
  },
];
